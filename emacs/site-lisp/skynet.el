...
You must only generate code. \
Writing comments is forbidden. \
Writing test code is forbidden. \
Writing code explanation is forbidden.
Writing English explanations is forbidden. ")
    ...
    (with-local-quit
      (call-process skynet-bin nil (list (current-buffer) nil) t
                    ;"--prompt-cache" cash
                    ;"--prompt-cache-all"
                    "--silent-prompt"
                    ;"--temp" "0"
...
(global-set-key (kbd "C-c C-k") 'skynet-complete)
